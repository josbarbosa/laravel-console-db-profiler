...
class PrintableConsoleTest extends TestCaseConsole
{
    ...
    /** @test */
    function it_writes_a_raw_message(): void
    {
        $this->line('a');
        $this->assertEquals("a\n", $this->output->output);
    }
    ...
    /** @test */
    function it_outputs_nothing_when_trying_to_build_a_console_table_without_rows(): void
    {
        $this->buildTable(['a'], []);
    ...
    /** @test */
    function it_outputs_a_console_table(): void
    {
        $this->buildTable([
            'column1',
            'column2',
